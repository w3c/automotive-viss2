...
func main() {
	...
	parser := argparse.NewParser("print", "External CAN Driver Simulator")
	...
	canSignals := []string{"Mabx_D_CrnkngSrvcStat", "Mabx_D_ExtrLghtngSrvcStat", "Mabx_D_HzrdLghtSrvcStat", "Mabx_D_IgntnSrvcStat", "Mabx_D_Shft2PSrvcStat", "Mabx_D_WndwSrvcStat", "Mabx_D_HrnSrvcStat", "Mabx_D_MrSrvcStat", "Mabx_D_LckngSrvcStat"}  // simulated signals
	...
	for {
		...
		default:
			...
			domainData.Name = canSignals[rand.Intn(9)]
			domainData.Value = strconv.Itoa(rand.Intn(7))
